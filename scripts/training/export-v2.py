...
root=Path('models/local-training');run=root/'aurora-lora-v2';out=run/f'export-e{args.epoch}'
...
license=(root/'base/LICENSE').read_text(encoding='utf-8');model_name=f'aurora-local:1.5b-v2-e{args.epoch}'
