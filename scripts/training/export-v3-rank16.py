"""Merge an immutable epoch adapter, export and quantize with pinned local
tools. Fase A.1 rank-variation experiment (docs/ROADMAP_MODELO_LOCAL.md)."""
...
root=Path('models/local-training');run=root/'aurora-lora-v3-rank16';out=run/f'export-e{args.epoch}'
...
license=(root/'base/LICENSE').read_text(encoding='utf-8');model_name=f'aurora-local:1.5b-v3-rank16-e{args.epoch}'
