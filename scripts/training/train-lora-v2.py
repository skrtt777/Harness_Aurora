...
parser.add_argument('--run', default='aurora-lora-v2')
...
def encode(path):
    ...
    return rows
train=encode(root/'dataset-v2/train.jsonl'); dev=encode(root/'dataset-v2/dev.jsonl')
def batch(rows):
